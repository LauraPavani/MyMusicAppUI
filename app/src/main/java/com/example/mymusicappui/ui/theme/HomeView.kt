...
@Composable
fun Home(){
    val categories = listOf("Hits", "Happy", "Workout", "Running", "Yoga", "Sleep", "Mystery & Thriller","Cooking & Dining")
    val grouped = listOf<String>("New Releases", "Favorites", "Top Rated", "Radio", "Trending").groupBy { it[0] }
    LazyColumn{
        grouped.forEach{
            stickyHeader {
